...
RUN unzip android-ndk-r18b-linux-x86_64.zip -d ${HOME}/android-tools

RUN rm sdk-tools-linux-4333796.zip android-ndk-r18b-linux-x86_64.zip
...
RUN ${HOME}/android-tools/android-ndk-r18b/build/tools/make-standalone-toolchain.sh --verbose --install-dir=${HOME}/android-tools/arm-linux-androideabi-vanilla/android-21 --platform=android-21 --toolchain=arm-linux-androideabi
